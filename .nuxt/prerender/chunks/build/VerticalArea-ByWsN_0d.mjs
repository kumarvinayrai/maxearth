import { reactive, unref, useSSRContext } from 'file://D:/Project_1205/maxearth/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass } from 'file://D:/Project_1205/maxearth/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div style="${ssrRenderStyle(!unref(loading) ? null : { display: "none" })}" data-v-c17d09d1>`);
      _push(ssrRenderComponent(_sfc_main$1, null, null, _parent));
      _push(ssrRenderComponent(GlobalSection, { fileName: "Verticals.txt" }, null, _parent));
      _push(`<section id="verticals" class="service-area bg py-120" data-v-c17d09d1><div class="container" data-v-c17d09d1><div class="row" data-v-c17d09d1><div class="col-lg-6 mx-auto text-center" data-v-c17d09d1><div class="site-heading" data-v-c17d09d1><span class="site-title-tagline" data-v-c17d09d1>${ssrInterpolate(service.headingTagline)}</span><h2 class="site-title" data-v-c17d09d1>${ssrInterpolate(service.headingBefore)} <span data-v-c17d09d1>${ssrInterpolate(service.headingHighlight)}</span> ${ssrInterpolate(service.headingAfter)}</h2></div></div></div><div class="row g-4" data-v-c17d09d1><!--[-->`);
      ssrRenderList(service.items, (item, index) => {
        _push(`<div class="col-md-6 col-lg-3" data-v-c17d09d1><div class="service-item wow fadeInUp"${ssrRenderAttr("data-wow-delay", `${0.25 * index}s`)} data-v-c17d09d1><div class="service-img position-relative overflow-hidden" data-v-c17d09d1><img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.title)} class="img-fluid w-100 rounded-0" data-v-c17d09d1><div class="service-icon position-absolute top-50 start-50 translate-middle" data-v-c17d09d1><i class="${ssrRenderClass(item.iconClass)}" data-v-c17d09d1></i></div></div><div class="service-content p-3" data-v-c17d09d1><h3 class="service-title" data-v-c17d09d1><a${ssrRenderAttr("href", item.link)} data-v-c17d09d1>${ssrInterpolate(item.title)}</a></h3><p class="truncate-txt" data-v-c17d09d1>${ssrInterpolate(item.description)}</p><div class="service-shadow-icon" data-v-c17d09d1><i class="${ssrRenderClass(item.iconClass)}" data-v-c17d09d1></i></div></div></div></div>`);
      });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/VerticalArea/VerticalArea.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const VerticalArea = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c17d09d1"]]);

export { VerticalArea as default };
//# sourceMappingURL=VerticalArea-ByWsN_0d.mjs.map
