...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))}><div class="container"><div class="row align-items-center gy-5"><div class="col-12"><div class=""><div class="site-heading mb-3"><span class="site-title-tagline">Mining Equipment</span><h2 class="site-title"> We at Max Earth Resources Limited attempts to live to the <span>Dreams</span> We See. </h2></div><p class="mb-4"> Max Earth Resources Limited is a leading mining company in India, specializing in Mining Equipment and Mining Equipment like Black Strap Metal and Manganese. With operations across Jharkhand, Maharashtra, Odisha, and Kerala, we are committed to innovation, sustainability, and industrial growth. </p><p class="mb-4"> The Group has strong Inspiration to Contribute to the Nation\u2019s economy through its contributions in the Mining Equipment and Mining Equipment Mineral Mining, Processing, Blending, Marketing and Sales in India and abroad. It comes to the Group as Intrinsic Traits, and therefore, we can humbly notify that as an Institutional Mining Equipment, we are the largest Black Strap Mining Equipment and Manufacturer of Black Strap Metal in the State of Jharkhand, with an annual Production surpassing 2 Lakhs Ton. </p><ul class="about-list list-unstyled mb-4"><li><i class="fa-solid fa-circle-check me-2 txt-warning"></i> At vero eos et accusamus et iusto odio. </li><li><i class="fa-solid fa-circle-check me-2 txt-warning"></i> Established fact that a reader will be distracted. </li><li><i class="fa-solid fa-circle-check me-2 txt-warning"></i> Sed ut perspiciatis unde omnis iste natus sit. </li></ul></div></div></div></div></section>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Verticals/miningEquipment.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const miningEquipment = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { miningEquipment as default };
//# sourceMappingURL=miningEquipment-JAbNTuED.mjs.map
